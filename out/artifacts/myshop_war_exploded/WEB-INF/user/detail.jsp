			...
			<div class="detail cf">
				...
				<div class="f-l filmslide">
					...
					<div id="vertical" class="bigImg">
						<img src="${ctx}/static/images/mid/12da.jpg" width="380" height="380" alt="" id="midimg" />
					...
					<div class="smallpic">
						...
						<div class="smallscroll" id="imageMenu">
							<ul>
								<li id="onlickImg"><img src="${ctx}/static/images/small/12da.jpg" /></li>
								<li><img src="${ctx}/static/images/small/12da.jpg" /></li>
								<li><img src="${ctx}/static/images/small/12da.jpg" /></li>
								<li><img src="${ctx}/static/images/small/12da.jpg" /></li>
								<li><img src="${ctx}/static/images/small/12da.jpg" /></li>
								<li><img src="${ctx}/static/images/small/12da.jpg" /></li>
					...
					<div class="dl06">
						...
						<div class="hgscrollbox">
							...
							<div class="hgscrollpic">
								<ul>
									<li>
										<a href="#"><img src="${ctx}/static/images/1119969_115x115.jpg" width="115" height="115" alt="" /></a>
										<dl>
				...
				<div class="dtsummary">
					<dl>
						...
						<dd>
							...
							<div class="dtprodis">
								<img src="${ctx}/static/images/32asd.jpg" width="797" height="298" alt="" />
							</div>
							<div class="dtbq">
								<h3>品牌介绍</h3>
					...
					<dl>
						...
						<dd class="discusstabcon">
							...
							<div class="discusslist">
								<ul>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="${ctx}/static/images/qzx.gif" width="48" height="48" alt="" /></a><span>cho***</span></div>
					...
					<dl>
						...
						<dd class="discusstabcon">
							<div class="afqlist">
								...
								<div class="myanswer">
									<a class="f-r" href="#"><img src="${ctx}/static/images/myanswer.gif" width="60" height="22" alt="我来解答" align="baseline" /></a><span class="f-r">共有1条解答</span>
								</div>
							</div>
							<div class="afqlist">
								<dl class="cf">
